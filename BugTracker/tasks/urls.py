...
urlpatterns = [
    ...
    path('manager/change_username/<int:user_id>/', views.change_username_view, name='change_username'),
    ...
    path('user/register_user/<str:username>/<str:password>', views.register_user_view, name='register_user'),
    path('user/user_login/<str:username>/<str:password>', views.user_login_view, name='user_login'),
]
